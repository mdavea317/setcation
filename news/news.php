...
<!--SLIDER--->
		...
		<section class="section1">
            ...
            <div class="text-cont">
                <h3 style="text-transform: uppercase;"> <a href="http://127.0.0.1/setcation/explore/explorectg.php?id=<?php echo $row["categoryid"]; ?>"> <?php echo $row["category"]; ?> </a> </h3>
		...
		<section class="wrapper">
        	...
        	<a href="http://127.0.0.1/setcation/news/"> News </a> &gt;
